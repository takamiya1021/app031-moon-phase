...
### Phase 9: 月齢計算高精度化 & ビジュアル改善 ✅ 完了
- [x] Jean Meeusアルゴリズム実装 (`lib/moonPhase.ts`)
  - J2000.0エポック基準の計算
  - 太陽・月の黄経補正
  - 複数の摂動項による高精度化
  - 検証: 新月0.003日、満月14.759日
- [x] 月の名称ロジック改善
  - 前日・当日・翌日比較で最も近い日のみに名前付与
  - 周期境界（月齢28.5+）の新月検出修正
- [x] ビジュアル調整
  - 色調: RGB (0.92, 0.96, 1.05) - 青白色
  - 明るさ: litBrightness 1.9
  - コントラスト緩和: sphericalShading調整
  - ハイライト削除: specularBoost除去
- [x] AIコンテンツ拡張
  - 「心と体のサイクル」セクション追加
  - 4セクション構成に更新
